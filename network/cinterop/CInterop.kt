...
open class CompileSwiftTask @Inject constructor(
    ...
    private fun createDefFile(libPath: File, headerPath: File, packageName: String) {
        ...
        val content = """
            ...
            linkerOpts = -L/usr/lib/swift -$linkerPlatformVersion ${minOs(compileTarget)}.0 ${
            minOs(
                compileTarget
            )
        }.0 -L${xcodePath}/Toolchains/XcodeDefault.xctoolchain/usr/lib/swift/${compileTarget.os()}
        """.trimIndent()
